...
contract MockOracle is IOracle {
  ...
  function getMetrics(uint256 profileId) external view override returns (uint256, uint256, uint256, uint256) {
    return (igFollowers[profileId], igPosts[profileId], ytSubscribers[profileId], ytVideos[profileId]);
  }
}
